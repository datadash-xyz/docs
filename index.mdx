...
<CardGroup cols={3}>
  ...
  <Card title="Follow updates" icon="megaphone" href="https://x.com/datadashxyz">
...
Or skip the code entirely: connect the [MCP server](/mcp-server) to Claude, Cursor or VS Code and ask questions of the data in plain English.
